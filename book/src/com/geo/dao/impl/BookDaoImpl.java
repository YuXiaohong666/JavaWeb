...
public class BookDaoImpl extends BaseDao implements BookDao {
    ...
    public int updateBook(Book book, Integer id) {
        String sql = "update t_book set `name`=?,`author`=?,`price`=?,`sales`=?,`stock`=?,`image_path`=? where id = ?";
    ...
    public List<Book> queryAllBook() {
        String sql = "select `id`,`name`,`author`,`price`,`sales`,`stock`,`image_path` imgPath from t_book";
    ...
    public List<Book> queryForPageItems(int begin, int pageSize) {
        String sql = "select `id`,`name`,`author`,`price`,`sales`,`stock`,`image_path` imgPath  from t_book limit ?,?";
